...
ADAMEquipmentProtocolErpWeb = ScaleProtocol(
    name='Adam Equipment Erp Web',
    baudrate=9600,
...
class AdamEquipmentDriverErpWeb(ScaleDriver):
    """Driver for the Adam Equipment serial scale."""

    _protocol = ADAMEquipmentProtocolErpWeb
    priority = 99  # Test the supported method of this driver last, after all other serial drivers

    def __init__(self, identifier, device):
        super(AdamEquipmentDriverErpWeb, self).__init__(identifier, device)
